%global product_build_number 101
...
Source1: https://repository.jboss.org/nexus/content/groups/ea/org/jboss/amq/jboss-a-mq/6.2.0.redhat-%{product_build_number}/jboss-a-mq-6.2.0.redhat-%{product_build_number}.zip
